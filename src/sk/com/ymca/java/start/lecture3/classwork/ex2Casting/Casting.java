...
public class Casting {
    public static void main(String[] args) {
        ...
        b = a;         // 0000 0000 0000 0000 0000 0000 0000 1010 - 4_bytes


        System.out.println(
                "Implict 'byte to int' = " + b + ITaskConstants.NEW_LINE + ITaskConstants.DELIMITER
        );
        ...
        d = c;
        System.out.println(
                "Implict 'int to float' = " + d +
                        ITaskConstants.NEW_LINE + ITaskConstants.DELIMITER)
        ;

        // Явне перетворення (implict) НЕБЕЗПЕЧНЕ (з більшого типу в менший)
        int e = 100;    // 0000 0000 0000 0000 0000 0000 1000 0000 - 4_bytes
        short f = 0;     //                               0000 0000 - 1_byte
        f = (short) e;   //                               0000 000v1 - 1_byte
        System.out.println(
                "Expict 'int to byte' = " + f + ITaskConstants.NEW_LINE
        ...
        h = (int) g;
        System.out.println(
                "Implict 'int to float' = " + h + ITaskConstants.NEW_LINE +
                        ITaskConstants.DELIMITER
        );
        ...
        float j = 3.5f/5;
        System.out.println(
                "i = " + i + ITaskConstants.NEW_LINE + "j = " + j +
                        ITaskConstants.NEW_LINE + ITaskConstants.DELIMITER)
        ;
        ...
        /*
         Явне перетворення з константи відбувається таким самим чином як і зі змінною,
         з втратою частини даних.
         */
        final int n = 254;
        byte o = 0;
        o = (byte) n;
        ...
        /*
         При перетвворині дробового типу (float, double)
         y цілочисловий тип (byte, int e.t.c) дробова частина не враховується
         */
